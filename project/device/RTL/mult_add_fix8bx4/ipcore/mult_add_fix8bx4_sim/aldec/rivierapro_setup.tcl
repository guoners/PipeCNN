...
# ACDS 16.0 222 linux 2017.02.20.10:15:11
# ----------------------------------------
...
# ----------------------------------------
# If mult_add_fix8bx4 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "mult_add_fix8bx4"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/mult_add_fix8bx4.v"
}
